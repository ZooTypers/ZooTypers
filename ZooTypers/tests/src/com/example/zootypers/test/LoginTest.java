...
public class LoginTest extends ActivityInstrumentationTestCase2<TitlePage> {
    ...
    protected void setUp() throws Exception {
        ...
        joinNow = (Button) getActivity().findViewById(com.example.zootypers.R.id.join_now);
        loginButton = (Button) getActivity().findViewById(com.example.zootypers.R.id.login_button);
    }
